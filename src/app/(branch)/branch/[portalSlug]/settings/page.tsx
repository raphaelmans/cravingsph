...
export default function BranchPortalSettingsPage() {
  ...
  const {
    ...
    isSavingWeeklyHours,
  } = useBranchSettings(ctx.restaurantId, ctx.branchId);
  ...
  const publicPath = appRoutes.restaurant.bySlug(ctx.restaurantSlug);
      ...
      <>
        ...
        <div className="flex-1 p-4 md:p-6">
          <AppEmptyState
            ...
            description="This branch could not be loaded. Return to the overview page."
            primaryAction={
              <Button variant="outline" shape="pill" asChild>
                <a href={appRoutes.branchPortal.byPortalSlug(ctx.portalSlug)}>
                  Back to overview
                </a>
              </Button>
            }
