...
/**
 * Creates a new QueryClient with SSR-optimized defaults.
 */
 ...
 * - Browser: Reuses the same QueryClient (singleton)
 *
 * This is important for SSR to avoid sharing state between users.
 */
