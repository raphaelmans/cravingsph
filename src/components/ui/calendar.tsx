  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          "bg-primary/10 text-foreground rounded-md data-[selected=true]:rounded-none",
